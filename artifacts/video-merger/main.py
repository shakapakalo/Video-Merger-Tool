...
def _normalize_clip(
    ...
    # Zoom: CapCut-style scale where:
    #   zoom=1.0 → CapCut 100 → no zoom
    #   zoom=1.1 → CapCut 101 → 1% bigger
    #   zoom=1.2 → CapCut 102 → 2% bigger
    #   zoom=1.3 → CapCut 103 → 3% bigger
    #   zoom=2.0 → CapCut 110 → 10% bigger
    #   zoom=3.0 → CapCut 120 → 20% bigger
